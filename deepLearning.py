...
face_detection_model = cv2.dnn.readNetFromCaffe('./models/deploy.prototxt',
...
labels =['Mask', 'No Mask', 'Covered Mouth Chin', 'Covered Nose and Mouth']
...
def face_mask_prediction(img):
    ...
    for i in range(0,detection.shape[2]):
        ...
        if confidence > 0.5:
            ...
            face_bob_rotate = cv2.rotate(face_blob_squeeze , cv2.ROTATE_90_CLOCKWISE)
